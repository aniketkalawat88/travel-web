      ...
      <div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-6 md:my-4 max-md:my-2">
            {
                ...
                <div className="">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <Link href={'tel:+919456583256'} className="text-primary-main border-primary-main border md:py-2 max-md:py-2 md:px-4 md:rounded-lg rounded-sm text-center w-full md:text-base sm:text-sm text-xs">
                      Call Now
                      </Link>
